...
*/
export function compile(file_name, sources, config) {
    const ptr0 = passStringToWasm0(file_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.compile(ptr0, len0, addHeapObject(sources), addHeapObject(config));
...
* @returns {ParseResult}
*/
export function parse(file_name, sources) {
    const ptr0 = passStringToWasm0(file_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.parse(ptr0, len0, addHeapObject(sources));
...
* @returns {R1csResult}
*/
export function generate_r1cs(file_name, sources, config) {
    const ptr0 = passStringToWasm0(file_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.generate_r1cs(ptr0, len0, addHeapObject(sources), addHeapObject(config));
    return R1csResult.__wrap(ret);
}
...
export class CompilationResult {
    ...
    */
    program() {
        const ret = wasm.compilationresult_program(this.__wbg_ptr);
    ...
    */
    input_signals(name) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.compilationresult_input_signals(this.__wbg_ptr, ptr0, len0);
        return takeObject(ret);
    }
    /**
    * @returns {any}
...
export class ParseResult {
    ...
    */
    report() {
        const ret = wasm.parseresult_report(this.__wbg_ptr);
        return takeObject(ret);
    }
    /**
    ...
    * @returns {any}
    */
    get_report_name(report_id) {
        const ret = wasm.parseresult_get_report_name(this.__wbg_ptr, report_id);
        return takeObject(ret);
    }
}
/**
...
export class R1csResult {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(R1csResult.prototype);
        obj.__wbg_ptr = ptr;
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_r1csresult_free(ptr);
    }
    /**
    * @returns {Uint8Array}
    */
    program() {
        const ret = wasm.r1csresult_program(this.__wbg_ptr);
        return takeObject(ret);
    }
    /**
    * @returns {any}
